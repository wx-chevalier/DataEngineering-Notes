...
[大数据汇聚](https://ng-tech.icu/books/DistributedSystem-Series/#/?q=大数据)、[数据处理与分析](https://ngte-aidl.gitbook.io/?q=数据处理)、《[CG-Series](https://github.com/wx-chevalier/CG-Series?q=)》这三者构成了数据科学的主要流程，本篇数据可视化更多地关注于数据展示相关的技术知识。
