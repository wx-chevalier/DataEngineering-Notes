...
![用户维度表](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325124342.png)
...
![用户维度表修改前](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125511.png)

修改后：

![用户维度表修改后](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125534.png)
...
![修改前](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125627.png)

修改后：

![修改后](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125644.png)

## 增加维度新列

用不同的字段来保存不同的值，就是在表中增加一个字段，这个字段用来保存变化后的当前值，而原来的值则被称为变化前的值。总的来说，这种方法通过添加字段来保存变化后的痕迹。例如用户维度表修改前：

![修改前](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125744.png)

修改后：

![修改后](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125810.png)

## 使用历史表

另外建一个表来保存历史记录，这种方式就是将历史数据与当前数据完全分开来，在维度中只保存当前最新的数据。用户维度表：

![用户维度表](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125848.png)

用户维度历史表：

![用户维度历史表](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325125912.png)
...
![商品表](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325130217.png)

2019 年 12 月 20 日的数据如下所示：

![历史数据](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325130315.png)
...
![商品拉链表的数据](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325130505.png)
...
![商品拉链表新数据](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325130544.png)
...
![商品拉链表新数据](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325130627.png)
...
![历史快照数据](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325131519.png)
...
![最新的商品快照](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230325131548.png)
